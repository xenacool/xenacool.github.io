    ...
    for camera in &cameras {
        ...
        for (prop, val) in &camera.properties {
            if prop.starts_with("neighbor_")
                && let PropertyValue::Float(target_id) = val
            {
...
mod tests {
    ...
    fn test_valid_camera_symmetry() {
        ...
        history.push_and_apply(Event::UpdateProperty {
            id: 10,
            property: "neighbor_right".to_string(),
            value: PropertyValue::Float(11.0),
        });
        ...
        history.push_and_apply(Event::UpdateProperty {
            id: 11,
            property: "neighbor_left".to_string(),
            value: PropertyValue::Float(10.0),
        });
        history.push_and_apply(Event::UpdateProperty {
            id: 11,
            property: "neighbor_up".to_string(),
            value: PropertyValue::Float(12.0),
        });
        ...
        history.push_and_apply(Event::UpdateProperty {
            id: 12,
            property: "neighbor_down".to_string(),
            value: PropertyValue::Float(11.0),
        });
    ...
    fn test_asymmetric_camera_symmetry() {
        ...
        history.push_and_apply(Event::UpdateProperty {
            id: 20,
            property: "neighbor_right".to_string(),
            value: PropertyValue::Float(21.0),
        });
    ...
    fn test_broken_chain_camera_symmetry() {
        ...
        history.push_and_apply(Event::UpdateProperty {
            id: 30,
            property: "neighbor_right".to_string(),
            value: PropertyValue::Float(31.0),
        });
