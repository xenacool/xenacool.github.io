...
pub struct UniformLocations {
    ...
    pub spritestack_cutout: Option<WebGlUniformLocation>,
...
pub struct RenderContext {
    ...
    /// State at `last_index`, used to walk sequential history deltas without
    /// rebuilding the entire log prefix on every animation frame.
...
impl RenderContext {
    pub fn new(
        ...
        let uniforms = UniformLocations {
            ...
            spritestack_cutout: gl.get_uniform_location(&program, "uSpritestackCutout"),
